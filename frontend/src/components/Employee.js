          ...
          <div className="signcontainer">
            ...
            <div className="col-sm">
              <Form.Group>
                ...
                <br></br>
                <input type="radio" name="gender" defaultValue="Male"  disabled={disabled} defaultChecked={!employee.isFemale} {...register("gender",{required:true})} onChange={(e)=>{employee.gender=e.target.value}}/> Male
                <input type="radio" name="gender" defaultValue="Female"  disabled={disabled} defaultChecked={employee.isFemale} {...register("gender",{required:true})} onChange={(e)=>{employee.gender=e.target.value}}/> Female
              </Form.Group>
          ...
          <div className="signcontainer">
            <div className="row">
              <div className="col-sm">
                <Form.Group>
                  ...
                  <Form.Control type="text" name="employeeId" defaultValue={employee.employeeId} placeholder={employee.employeeId} {...register("employeeId",{ required:true})} 
                  disabled={disabled} onChange={(e)=>{employee.employeeId=e.target.value}}/>
                </Form.Group>
                {errors.employeeId && <p className='errorMsg'>Employee ID is required!</p>}
              </div>
              <div className="col-sm">
                <Form.Group>
            ...
            <div className="row">
              ...
              <Form.Group>
                ...
                <br></br>
                <input type="radio" name="fullTime" defaultValue="Yes" disabled={disabled} defaultChecked={employee.fullTime} {...register("fullTime",{required:true})} onChange={(e)=>{employee.fullTime=e.target.value}}/> Yes
                <br></br>
                <input type="radio" name="fullTime" defaultValue="No" disabled={disabled} defaultChecked={!employee.fullTime} {...register("fullTime",{required:true})} onChange={(e)=>{employee.fullTime=e.target.value}}/> No
              </Form.Group>
              {errors.fullTime && <p className='errorMsg'>Full time/Part time details are required!</p>}
              </div>
              <div className="col-sm">
              <Form.Group>
                <Form.Label>Supervisor?</Form.Label>
                <br></br>
                <input type="radio" name="supervisor" defaultValue="Yes" disabled={disabled} defaultChecked={employee.supervisor} {...register("supervisor",{required:true})} onChange={(e)=>{employee.supervisor=e.target.value}} /> Yes
                <br></br>
                <input type="radio" name="supervisor" defaultValue="No" disabled={disabled} defaultChecked={!employee.supervisor} {...register("supervisor",{required:true})} onChange={(e)=>{employee.supervisor=e.target.value}}/> No
              </Form.Group>
